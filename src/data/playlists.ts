...
export const playlists: Playlist[] = [
  { id: '1', nome: 'Emo Noite Adentro', descricao: 'Para ouvir de fone às 3 da manhã', capa: require('../../assets/images/capas/01.png'), faixas: ['1', '7', '9', '10'] },
  { id: '2', nome: 'Gótico', descricao: 'Sombras e sintetizadores', capa: require('../../assets/images/capas/06.png'), faixas: ['3', '5', '6', '8'] },
  { id: '3', nome: 'Nostalgia 2000s', descricao: 'Direto da adolescência', capa: require('../../assets/images/capas/04.png'), faixas: ['2', '4', '7', '1'] },
